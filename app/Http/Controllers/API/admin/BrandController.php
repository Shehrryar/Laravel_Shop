...
class BrandController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totalPages = $brands->lastPage(); // Total number of pages
        $currentPage = $brands->currentPage(); // Current page number
        $brandsData = $brands->items(); // Extract brands as an array
        $newbrands['current_page'] = $currentPage;
        $newbrands['totalPages'] = $totalPages;
        $newbrands['brandsData'] = $brandsData;
        return response()->json([$newbrands]);
    }
