...
class CategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        $categoriesData = $categories->items(); // Extract categories as an array
        $newcategories['current_page'] = $currentPage;
        $newcategories['totalPages'] = $totalPages;
        $newcategories['categoriesData'] = $categoriesData;
