...
class LanguageController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totalPages = $language->lastPage(); // Total number of pages
        $currentPage = $language->currentPage(); // Current page number
        $languageData = $language->items(); // Extract language as an array
        $newlanguage['current_page'] = $currentPage;
        $newlanguage['totalPages'] = $totalPages;
        $newlanguage['languageData'] = $languageData;
