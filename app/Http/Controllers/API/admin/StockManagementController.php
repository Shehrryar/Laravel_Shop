...
class StockManagementController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totalPages = $stock->lastPage(); // Total number of pages
        $currentPage = $stock->currentPage(); // Current page number
        $stockData = $stock->items(); // Extract stock as an array
        $newstock['current_page'] = $currentPage;
        $newstock['totalPages'] = $totalPages;
        $newstock['stockData'] = $stockData;
        $newstock['colors'] = $colors;
        $newstock['sizes'] = $sizes;
