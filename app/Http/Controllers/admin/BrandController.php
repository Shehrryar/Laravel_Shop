...
class BrandController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $brands = $this->applyStoreScope($brands);
    ...
    public function store(Request $request)
    {
        ...
        if ($validater->passes()) {
            $brand = new Brand();
            $this->assignStoreId($brand, $request);
    ...
    public function edit($id, Request $request)
    {
        ...
        $this->ensureOwnStoreRecord($brand);
        if (empty($brand)) {
    ...
    public function update($id, Request $request)
    {
        ...
        $this->ensureOwnStoreRecord($brand_edit);
        if (empty($brand_edit)) {
            $request->session()->flash('error', 'Record not found');
            return response()->json([
                'status' => false,
    ...
    public function destroy($brnd_id, Request $request)
    {
        ...
        $this->ensureOwnStoreRecord($brnd_del);
        if (empty($brnd_del)) {
