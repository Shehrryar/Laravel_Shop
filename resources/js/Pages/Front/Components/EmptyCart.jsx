    ...
    <>
      ...
      <section className="px-15">
        <div className="empty-cart-section text-center">
          ...
          <p>
            Looks like you haven’t added anything to your cart yet. You’ll find
            lots of interesting products on our “Shop” page.
          </p>
          <Link href={route("front.shop")} className="btn btn-solid w-100">
            Start Shopping
          </Link>
        </div>
      </section>
