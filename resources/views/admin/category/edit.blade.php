                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Name" value="{{ $cat_edit->name }}">
                                    <p id="para_name"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input readonly type="text" name="slug" id="slug" class="form-control"
                                        placeholder="Slug" value="{{ $cat_edit->slug }}">
                                    <p id="para_slug"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="status" name="status" class="form-control">
                                        ...
                                        <option {{ $cat_edit->status == 0 ? 'selected' : '' }} value="0">Block</option>
                                    </select>
