		...
		<div class="container-fluid my-2">
			<div class="row mb-2">
				...
				<div class="col-sm-6 text-right">
					<a href='{{route("currency.create")}}' class="btn btn-primary">New Currency</a>
				</div>
			</div>
		</div>
		<!-- /.container-fluid -->
					...
					<div class="card-header">
						<div class="card-title">
							<button class="btn btn-default" type="button"
								onclick="window.location.href='{{route("currency.index")}}'">Reset</button>
						</div>
							...
							@if($currency->isNotEmpty())
								@foreach($currency as $curren)
									<tr>
										...
										<!-- <td><img src="{{ $curren->logo }}" alt="{{ $curren->name }}" width="50"></td> -->
										...
										<td>
											...
											<a href="#" onclick='delecurrency({{$curren->id}})' class="text-danger w-4 h-4 mr-1">
