...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="" method="post" id="edit_discount_form" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="discount_name" id="name" class="form-control"
                                        placeholder="Discount Name" value="{{ $discount_edit->name }}">
                                    <p id="para_name"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="status" name="status" class="form-control">
                                        ...
                                        <option {{ $discount_edit->status == 0 ? 'selected' : '' }} value="0">Block
                                        </option>
                                    </select>
                            ...
                            @php
                                $product_array = $discount_edit->product_ids ?? [];

                                if (!is_array($product_array)) {
                                    $product_array = explode(',', $product_array);
                                }

                                $product_array = array_map('intval', $product_array);
                            @endphp
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="type" name="type" class="form-control">
                                        ...
                                        <option {{ $discount_edit->type == 'fixed' ? 'selected' : '' }} value="fixed">
                                            Fixed
                                        </option>
                                    </select>
                                    <p id="para_type"></p>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="discount_amount" id="discount_amount" class="form-control"
                                        placeholder="Discount Amount" value="{{ $discount_edit->value }}">
                                    <p id="para_number"></p>
                                </div>
                            </div>
...
@section('customjs')
    <script>
        $(document).ready(function() {
            $("#edit_discount_form").submit(function(event) {
