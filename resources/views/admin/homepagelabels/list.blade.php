    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    @if ($isVendor)
                        <h1>My Store Homepage Labels</h1>
                    @else
                ...
                <div class="col-sm-6 text-right">
                    @if ($isVendor)
                        <a href="{{ route('homepage-labels.create') }}" class="btn btn-primary">Add My Label</a>
                    @else
                                ...
                                @foreach ($labels as $label)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Delete -->
                                            <a href="#" onclick='deleteLabel({{ $label->id }})'
                                                class="text-danger">
                                                <svg class="filament-link-icon w-4 h-4 mr-1"
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                    fill="currentColor" aria-hidden="true">
        ...
        if (confirm("Are you sure you want to delete: " + label_id)) {
            $.ajax({
                ...
                error: function(jqXHR) {
                    ...
                    alert('Something went wrong while deleting homepage label.');
                }
            });
        }
    }
