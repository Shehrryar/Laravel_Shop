				...
				<section class="content">
					...
					<div class="container-fluid">
						...
						<div class="card">
							...
							<button class="btn btn-default" type="button" onclick="window.location.href='{{route("language.index")}}'">Reset</button>
								</div>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a href="#" onclick='delelang({{$lang->id}})' class="text-danger w-4 h-4 mr-1">
