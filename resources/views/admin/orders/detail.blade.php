...
@section('content')
    @php
        ...
        $isVendor = $isVendor ?? $adminUser && (int) $adminUser->role === 3;
    @endphp
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="{{ $isVendor ? 'col-md-12' : 'col-md-9' }}">
                    <div class="card">
                            ...
                            <form action="" id="changeorderstatusform" name="changeorderstatusform" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $order->shipped_date }}" class="form-control"
                                            type="datetime-local" name="shipped_date" id="shipped_date">
                                    </div>
                                    <div class="mb-3">
