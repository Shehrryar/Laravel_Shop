            ...
            <div class="col-md-8">
                ...
                <div class="row" id="productgallery">
                    ...
                    <div class="card" id="image_row_{{$image->id}}" style="width: 18rem;">
                        ...
                        <img class="card-img-top" src="{{asset('upload/products/'.$image->image)}}" alt="Card image cap">
                        <div class="card-body">
                            <a href="javascript:void(0)" onclick="delete_image({{$image->id}})" class="btn btn-danger">Delete</a>
                        </div>
                    </div>
                    @endforeach
                    @endif
                    ...
                    <div class="card-body">	
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                <option {{($product->categories_id == $cati_data->id) ? 'selected': ''}} value="{{$cati_data->id}}">{{$cati_data->name}}</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sub_category" id="sub_category" class="form-control">
                                ...
                                <option {{($product->sub_category_id == $subcati_data->id) ? 'selected': ''}} value="{{$subcati_data->id}}">{{$subcati_data->name}}</option>
                    ...
                    <div class="card-body">	
                        ...
                        <div class="mb-3">
                            <select name="brand" id="brand" class="form-control">
                                ...
                                <option {{($product->brands_id == $brandi->id) ? 'selected': ''}} value="{{$brandi->id}}">{{$brandi->name}}</option>
                                @endforeach
                                @endif 
                            </select>
                        </div>
