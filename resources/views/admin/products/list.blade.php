            ...
            <form action="" method="get"> 
                <div class="card-header">
                    <div class="card-title">
                        <button class="btn btn-default" type="button" onclick="window.location.href='{{route("product.index")}}'">Reset</button>
                    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="{{asset('upload/products/'.$images_prod->image)}}" class="img-thumbnail" width="50" >
                            @else
