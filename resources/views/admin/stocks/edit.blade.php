                    ...
                    <div class="row">
                                ...
                                <select id="select_product[]" name="select_product[]" class="form-control">
                                    @if ($products->isNotEmpty())
										@foreach ($products as $product)
											<option {{($stock_edit->product_id == $product->id) ? 'selected' : ''}} value="{{$product->id}}"> {{ $product->title }}</option>
										@endforeach
                                    @endif
                                </select>
						...
						<div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="remaning_quantity" id="remaning_quantity" class="form-control"
                                placeholder="Remaining Quantity" value = "{{$stock_edit->remaning_quantity}}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="sold_quantity" id="sold_quantity" class="form-control"
                                    placeholder="Sold Quantity" value = "{{$stock_edit->sold_quantity}}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <option {{($stock_edit->status == 1) ? 'selected' : ''}} value="1">Active
                                    ...
                                    <option {{($stock_edit->status == 0) ? 'selected' : ''}} value="0">Block</option>
                                </select>
                                <p id="para_status"></p>
                            </div>
                        </div>
