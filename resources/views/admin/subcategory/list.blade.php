                            ...
                            @if ($subcategories->isNotEmpty())
                                @foreach ($subcategories as $scatname)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('subcategory.edit', $scatname->id) }}">
                                            ...
                                            <a href="#" onclick='delecategory({{ $scatname->id }})'
...
@section('customjs')
<script>
    function delecategory(id) {
        var delurl = '{{ route("subcategory.delete", "ID") }}'.replace("ID", id);
        ...
        if (confirm("Are you sure you want to delete " + id + "?")) {
            $.ajax({
                ...
                error: function(jqXHR) {
                    ...
                    alert('Something went wrong while deleting subcategory.');
                }
            });
        }
    }
