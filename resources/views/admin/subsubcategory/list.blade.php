    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    @if ($isVendor)
                        <h1>My Store Sub Category Level 3</h1>
                    @else
                        <h1>Sub Category Level 3</h1>
                    @endif
                </div>
                            ...
                            @if ($subsubcategories->isNotEmpty())
                                @foreach ($subsubcategories as $scatname)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('subsubcategory.edit', $scatname->id) }}">
                                            ...
                                            <a href="#" onclick='delesubsubcategory({{ $scatname->id }})'
...
@section('customjs')
    <script>
        function delesubsubcategory(id) {
            var delurl = '{{ route('subsubcategory.delete', 'ID') }}'.replace("ID", id);
            ...
            if (confirm("Are you sure you want to delete " + id + "?")) {
                $.ajax({
                    ...
                    error: function(jqXHR) {
                        ...
                        alert('Something went wrong while deleting Sub Category Level 3.');
                    }
                });
            }
        }
