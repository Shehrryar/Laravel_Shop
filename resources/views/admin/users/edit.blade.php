                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Name" value="{{ $user_edit->name }}">
                                    <p id="para_name"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control"
                                        placeholder="email" value="{{ $user_edit->email }}">
                                    <p id="para_email"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password" id="password" class="form-control"
                                        placeholder="Leave empty if you do not want to change password" value="">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control"
                                        placeholder="phone" value="{{ $user_edit->phone }}">
                                    <p id="para_phone"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="status" name="status" class="form-control">
                                        <option {{ $user_edit->status == 1 ? 'selected' : '' }} value="1">Active
                                        </option>
                                        <option {{ $user_edit->status == 0 ? 'selected' : '' }} value="0">Block
                                        </option>
                                    </select>
