            ...
            <div class="col-md-9">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('account.updateProfileData') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea name="address" id="address" class="form-control" rows="4">{{ old('address', Auth::user()->address) }}</textarea>
                                </div>
