        ...
        <div class="container">
            <div class="light-font">
                <ol class="breadcrumb primary-color mb-0">
                    <li class="breadcrumb-item"><a class="white-text" href="{{route(('front.home'))}}">{{trans("Home")}}</a>
                    </li>
                    <li class="breadcrumb-item"><a class="white-text" href="{{route(('front.shop'))}}">{{trans("Shop")}}</a>
                    </li>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        @php
                                                            $sizeName = optional(\App\Models\Size::find($item->size_id))->name;
                                                            $colorName = optional(\App\Models\Color::find($item->color_id))->name;
                                                        @endphp
                                                        @if($sizeName)
                                                            <span class="badge bg-secondary ms-2">{{ trans($sizeName) }}</span>
                                                        @endif
                                                        @if($colorName)
                                                            <span class="badge bg-info text-dark ms-2">{{ trans($colorName) }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </td>
