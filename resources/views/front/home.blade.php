        ...
        <div class="row pb-3">
            ...
            <div class="col-md-3">
                <div class="card product-card">
                    ...
                    @if ($f_product->qty > 0)
                    <a class="btn btn-dark" href="javascript:void(0)" onclick='addToCart({{ $f_product->id }}, {{ $getprice['discount_value'] }}, {{ $getprice['discounted_price'] }}, {{ $getprice['actual_price'] }})'>
            ...
            <div class="col-md-3">
                <div class="card product-card">
                    ...
                    @if ($late_prod->qty > 0)
                        ...
                        <div class="discount-badge">{{ $getprice['discount_value'] }}% OFF</div>
                        @endif
                        <a class="btn btn-dark" href="javascript:void(0)" onclick='addToCart({{ $late_prod->id }}, {{ $getprice['discount_value'] }}, {{ $getprice['discounted_price'] }}, {{ $getprice['actual_price'] }})'>
                        <i class="fa fa-shopping-cart"></i> {{trans('Add To Cart')}}
                    </a>
                    @else
                    <a class="btn btn-dark" href="javascript:void(0)" disabled>
