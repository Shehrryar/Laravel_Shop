...
use App\Http\Controllers\API\v2\admin\ShippingController;
use App\Http\Controllers\API\v2\AuthController;
use App\Http\Controllers\API\v2\admin\AdminLoginController;
use App\Http\Controllers\API\v2\admin\HomeController;
use App\Http\Controllers\API\v2\admin\CategoryController;
use App\Http\Controllers\API\v2\admin\imageuploadcontroller;
use App\Http\Controllers\API\v2\admin\SubCategoryController;
use App\Http\Controllers\API\v2\admin\SubSubCategoryController;
use App\Http\Controllers\API\v2\admin\BrandController;
use App\Http\Controllers\API\v2\admin\ProductController;
use App\Http\Controllers\API\v2\admin\ProductSubCategoryController;
use App\Http\Controllers\API\v2\admin\ProductImageControlller;
use App\Http\Controllers\API\v2\FrontController;
use App\Http\Controllers\API\v2\ShopController;
use App\Http\Controllers\API\v2\CartController;
use App\Http\Controllers\API\v2\LocalizationController;
use App\Http\Controllers\API\v2\admin\LanguageController;
use App\Http\Controllers\API\v2\admin\OrderController;
use App\Http\Controllers\API\v2\admin\UserController;
use App\Http\Controllers\API\v2\admin\ColorController;
use App\Http\Controllers\API\v2\admin\SizeController;
